  ...
  const generateImage = async () => {
    if(form.prompt) {
      try {
        ...
        const response = await fetch('http://localhost:3000/api/v1/imagin', {
          method: 'POST',
          headers: {
  ...
  return (
    <section className='max-w-7xl mx-auto'>
      <div>
        ...
        <p className='mt-2 text-[#666e75] text-[14px] max-w[500px]'>Create imaginative and visually stunning images through Imagen AI and share them with the community</p>
      </div>
